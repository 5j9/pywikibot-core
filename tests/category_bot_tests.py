...
class CfdActions(DefaultSiteTestCase):
    ...
    def test_strip_cfd_templates_does_nothing_when_no_templates(self, ignore):
    ...
    def test_strip_cfd_templates_with_spaces_in_comments(self, ignore):
    ...
    def test_strip_cfd_templates_without_spaces_in_comments(self, ignore):
