...
class TestCategoryDryObject(TestCase):
    ...
    def test_aslink(self):
        ...
        self.assertEqual(cat_section.title(as_link=True, insite=cat_section.site),
    ...
    def test_sortkey(self):
        ...
        self.assertEqual(cat.aslink(sort_key='Foo'), '[[Category:Wikipedia categories|Foo]]')
