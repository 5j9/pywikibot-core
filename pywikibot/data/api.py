...
class ParamInfo(Container):
    ...
    def _generate_submodules(self, modules):
        ...
        for module in modules:
            ...
            if self.site.mwversion() >= '1.26wmf9':
                ...
                if self.site.mwversion() < '1.24wmf18':
                    if module == 'main':
                        params = {'action'}
                    elif module == 'query':
...
class Request(MutableMapping):
    ...
    def __init__(self, site=None, mime=None, throttle=True, mime_params=None,
        ...
        if (self.write and self.site.mwversion() >= '1.23'
                or self.action == 'edit'
