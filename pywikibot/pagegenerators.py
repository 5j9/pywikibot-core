...
class GeneratorFactory(object):
    ...
    def _handle_onlyif(self, value):
        ...
        self._onlyif_onlyifnot_handler(value, False)

    def _handle_onlyifnot(self, value):
        """Handle `-onlyifnot` argument."""
        self._onlyif_onlyifnot_handler(value, True)
...
def _old_eventlog_handler_method_factory(log_type):
    ...
    # Using closue is a workaround for the lack of functools.partialmethod in
    # Python 2.7.
