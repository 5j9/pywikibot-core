...
for env_name in (
    'PYWIKIBOT2_DIR', 'PYWIKIBOT2_DIR_PWB', 'PYWIKIBOT2_USER_CONFIG',
    ...
    issue_deprecation_warning(
        '%s environment variable' % env_name,
...
def get_base_dir(test_directory=None):
    ...
    for arg in sys.argv[1:]:
        ...
        if ('PYWIKIBOT_DIR' in os.environ and
                exists(os.path.abspath(os.environ['PYWIKIBOT_DIR']))):
            base_dir = os.path.abspath(os.environ['PYWIKIBOT_DIR'])
        elif exists('.'):
